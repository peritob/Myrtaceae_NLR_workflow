...
fgrep -w -f ${prefix_name}_${NLR_type}.list ${prefix_name}_pfam.tsv > ${prefix_name}_${NLR_type}_Pfams.tsv
...
fgrep -wv -f NLR_Pfams.list ${prefix_name}_${NLR_type}_Pfams.tsv > ${prefix_name}_${NLR_type}_ID_Pfams.tsv
