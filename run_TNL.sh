...
#to run this script: run_TNL.sh interproscan_out.tsv augustus_out.gff3 > species_TNL.gff3
...
gawk 'BEGIN {FS="\t"} ($5=="G3DSA:1.10.8.430" || $5=="G3DSA:3.80.10.10" || $5=="PF08263" || $5=="PF13516"  || $5=="PF12799" || $5=="PF13306" || $5=="PF13855") { print $1 }' $1 | sort -k 1b,1 | uniq > temp2
join temp0 temp1 > temp3
join temp3 temp2 > TNL.list
